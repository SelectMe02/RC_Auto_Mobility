...
**역할 분배**
- 한주형 : 아두이노 라즈베리파이 시리얼 통신 및 송수신기 통신 제어. 송신기와 아두이노 통신을 통한 LED 제어. 아두이노를 통한 수동&자동 속도제어 및 자율 주행 로직 제어 및 라인 트레이싱 제어 담당.(기여도 100%)
- 강현 : 웹 소켓과 웹 브라우저 연동을 통한 라인 디텍싱 및 트레이싱 로직 제어. 송신기와 아두이노 통신을 통한 LED 제어. 실시간 웹 브라우징을 통한 수동 제어 가능 로직 담당. (기여도 100%)

---

## Youtube Link
[[RC 시연 영상]](https://www.youtube.com/watch?v=8f3zlM8xl1I)
...
| `throttlePulse > 1500 && < 1553` 보정 | 정지 상태(1500)와 미세 전진 상태 간의 충돌 방지 |
